...
"""
function fasta_file(
    family_id::AbstractString;
    rfam_dir = get_rfam_directory(),
    rfam_version = get_rfam_version(),
...
"""
function cm(; rfam_dir = get_rfam_directory(), rfam_version = get_rfam_version(), rfam_base_url = base_url(; rfam_version))
    lock(RFAM_LOCK) do
...
"""
function clanin(; rfam_dir = get_rfam_directory(), rfam_version = get_rfam_version(), rfam_base_url = base_url(; rfam_version))
    lock(RFAM_LOCK) do
...
"""
function seed(; rfam_dir = get_rfam_directory(), rfam_version = get_rfam_version(), rfam_base_url = base_url(; rfam_version))
    lock(RFAM_LOCK) do
